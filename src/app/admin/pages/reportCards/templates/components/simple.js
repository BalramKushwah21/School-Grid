        ...
        <div className="w-full h-full border-[1.5px] p-[4px] z-10 bg-transparent" style={{ borderColor: templateConfig.theme.primaryColor }}>
          <div className="w-full h-full border-[3px] border-double p-6 relative flex flex-col" style={{ borderColor: templateConfig.theme.primaryColor }}>
            ...
            <div className="mb-6 relative group flex-1">
              <button onClick={() => addSubject('scholastic')} className="absolute -left-6 top-10 text-amber-700 opacity-0 group-hover:opacity-100 print:hidden transition-all z-20" title="Add Subject"><PlusCircle size={20}/></button>
                  ...
                  {templateConfig.subjects.map((sub) => (
                    <tr key={sub.id} className="group/row hover:bg-slate-50">
                      <td className="border border-slate-400 p-1.5 text-left relative font-bold text-slate-800 pl-3">
                        <button onClick={() => removeRow('scholastic', sub.id)} className="absolute -left-6 bg-red-100 text-red-600 p-1 rounded opacity-0 group-hover/row:opacity-100 print:hidden"><Trash2 size={12}/></button>
            ...
            <div className="grid grid-cols-12 gap-6 mb-4">
               ...
               <div className="col-span-7 relative group">
                  <button onClick={() => addSubject('cocurricular')} className="absolute -left-6 top-6 text-amber-700 opacity-0 group-hover:opacity-100 print:hidden"><PlusCircle size={16}/></button>
                        ...
                        {templateConfig.coCurricular.map((item) => (
                           <tr key={item.id} className="group/row hover:bg-slate-50">
                              <td className="border border-slate-400 p-1.5 relative">
                                 <button onClick={() => removeRow('cocurricular', item.id)} className="absolute -left-6 bg-red-100 text-red-600 p-0.5 rounded opacity-0 group-hover/row:opacity-100 print:hidden"><Trash2 size={10}/></button>
