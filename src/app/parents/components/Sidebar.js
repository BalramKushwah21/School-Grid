...
// ==========================================
export default function ParentSidebar({ isOpen, onClose, schoolData }) {
	...
	return (
		<>
			{/* 🚨 Z-40 lagaya hai taaki ye Z-50 Header ke niche rahe 🚨 */}
			<aside
			...
			>
				...
				<div className="h-[88px] flex items-center justify-between px-6 border-b border-white/10 sticky top-0 z-10 shrink-0 w-[280px]">
					<div className="flex items-center gap-3">
						<User className="text-[#3b82f6] w-8 h-8" />
			...
			{/* Mobile Screen Overlay Background (z-30) */}
			{isOpen && (
				<div
					onClick={onClose}
